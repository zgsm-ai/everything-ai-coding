---
description: 'Search coding resources (MCP/Skills/Rules/Prompts). Usage: /coding-hub-search <query>'
...
1. Extract search keywords and optional type filter from `$ARGUMENTS`
   ...
   - Example: `/coding-hub-search typescript type:mcp` — search MCP type only
...
3. Download index to temp file: `curl -sf --compressed <index URL> -o "$TMPDIR/coding-hub-index.json"`
...
Section: "Top Candidates"
  ...
  Per item:
    ...
    - Next step: `/coding-hub-install <name>`
