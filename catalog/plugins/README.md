...
| 11 | [cospowers-task-planning](https://github.com/costrict-plugins-repo/cospowers-task-planning/tree/main/) | AI 驱动的任务拆解插件：将需求或设计拆解为实现计划、任务图、里程碑和执行策略。 | csc-plugins | 🟢 Active | 100 | 2026-06-24 | ai-ml | `cospowers`, `ai-workers` |
| 12 | [cospowers-tdd-development](https://github.com/costrict-plugins-repo/cospowers-tdd-development/tree/main/) | AI 驱动的 TDD 编码插件：基于任务、测试、issue 或 bug 执行测试优先开发、调试、代码检查和提交。 | csc-plugins | 🟢 Active | 100 | 2026-06-24 | ai-ml | `cospowers`, `ai-workers` |
| 13 | [cospowers-test-generation](https://github.com/costrict-plugins-repo/cospowers-test-generation/tree/main/) | AI 驱动的测试生成插件：从需求、设计、计划、bug 或代码生成测试策略、测试用例和测试代码草稿。 | csc-plugins | 🟢 Active | 100 | 2026-06-24 | testing | `cospowers`, `ai-workers` |
| 14 | [hookify](https://github.com/anthropics/claude-plugins-official/tree/main/plugins/hookify) | Claude Code plugin for creating custom hooks to prevent unwanted coding behavior... | Anthropic Official | 🟢 Active | 99 | 2026-05-08 | documentation | — |
| 15 | [mcp-server-dev](https://github.com/anthropics/claude-plugins-official/tree/main/plugins/mcp-server-dev) | Comprehensive guide for building MCP servers and interactive UI widgets for Clau... | Anthropic Official | 🟢 Active | 99 | 2026-05-08 | security | — |
| 16 | [plugin-dev](https://github.com/anthropics/claude-plugins-official/tree/main/plugins/plugin-dev) | A comprehensive toolkit with 7 expert skills for developing Claude Code plugins,... | Anthropic Official | 🟢 Active | 99 | 2026-05-08 | ai-ml | — |
| 17 | [skill-creator](https://github.com/anthropics/claude-plugins-official/tree/main/plugins/skill-creator) | A plugin for creating, testing, benchmarking, and optimizing Claude skills throu... | Anthropic Official | 🟢 Active | 99 | 2026-05-08 | testing | — |
...
| 19 | [microsoft-docs](https://github.com/MicrosoftDocs/mcp.git) | A plugin for AI-assisted coding that provides access to official Microsoft docum... | Anthropic Official | 🟢 Active | 99 | 2026-06-04 | backend | `azure` |
...
| 31 | [gitnexus](https://github.com/abhigyanpatwari/GitNexus/tree/main/gitnexus-claude-plugin) | GitNexus is a Claude plugin providing AI-powered code intelligence via a knowled... | claude-plugins.dev | 🟢 Active | 97 | 2026-05-22 | tooling | `git` |
...
| 34 | [planning-with-files](https://github.com/OthmanAdi/planning-with-files/tree/master/) | A plugin for AI coding assistants that uses persistent markdown files for struct... | claude-plugins.dev | 🟢 Active | 97 | 2026-05-01 | documentation | — |
...
| 37 | [claude-seo](https://github.com/AgriciDaniel/claude-seo/tree/main/) | Comprehensive SEO analysis plugin for Claude Code with 25 sub-skills covering te... | claude-plugins.dev | 🟢 Active | 97 | 2026-06-12 | devops | `seo`, `technical-seo`, `content-quality` |
