...
<p>
  ...
  <img src="https://img.shields.io/badge/resources-12823-2ECC71?style=flat-square" alt="Resources" />
</p>
...
### [🔌 MCP 服务器](./catalog/mcp/) — <!-- README_COUNT_MCP:START -->7102<!-- README_COUNT_MCP:END --> 个条目
...
### [🎯 Skills 技能](./catalog/skills/) — <!-- README_COUNT_SKILL:START -->4037<!-- README_COUNT_SKILL:END --> 个条目
