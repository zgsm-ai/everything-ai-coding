...
<p><strong><!-- README_APPROX_COUNT:START -->9900<!-- README_APPROX_COUNT:END -->+ 精选 AI 编程资源 — 浏览、评估、安装</strong><br/>MCP Servers · Skills · Rules · Prompts · Plugins</p>
...
### [🔌 MCP 服务器](./catalog/mcp/) — <!-- README_COUNT_MCP:START -->6457<!-- README_COUNT_MCP:END --> 个条目
...
| 名称 | ⭐ Stars | 评分 | 描述 |
|------|----------|------|------|
| [upstash/context7](https://github.com/upstash/context7) | 56.5k | 98 | 实时注入最新库文档和代码示例到 LLM 上下文的 MCP 服务器，消除 API 幻觉。 |
| [ChromeDevTools/chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | 42.5k | 98 | 谷歌官方 MCP 服务器，让 AI 编程代理直接操控 Chrome DevTools 进行调试、性能分析和浏览器自动化。 |
| [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp) | 33.3k | 98 | 微软官方 MCP 服务器，通过 Playwright 让 AI 精确控制浏览器进行网页自动化和数据抓取。 |
| [github/github-mcp-server](https://github.com/github/github-mcp-server) | 30.3k | 98 | GitHub 官方 MCP 服务器，让 AI 工具通过 API 深度集成 GitHub，实现仓库管理、Issue/PR 自动化和 CI/C… |
| [googleapis/genai-toolbox](https://github.com/googleapis/genai-toolbox) | 15.4k | 98 | Google官方MCP服务器，将AI代理和IDE连接到企业数据库，提供预构建工具和自定义框架。 |
<!-- README_TOP5_MCP:END -->
...
### [🎯 Skills 技能](./catalog/skills/) — <!-- README_COUNT_SKILL:START -->1828<!-- README_COUNT_SKILL:END --> 个条目
...
### [💡 Prompts 提示词](./catalog/prompts/) — <!-- README_COUNT_PROMPT:START -->606<!-- README_COUNT_PROMPT:END --> 个条目
...
### [🧩 Plugins 插件](./catalog/plugins/) — <!-- README_COUNT_PLUGIN:START -->843<!-- README_COUNT_PLUGIN:END --> 个条目
