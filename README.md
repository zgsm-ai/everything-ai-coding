...
<p><strong><!-- README_APPROX_COUNT:START -->24800<!-- README_APPROX_COUNT:END -->+ curated AI coding resources — browse, evaluate, install</strong><br/>MCP Servers · Skills · Rules · Prompts · Plugins</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/resources-24858-2ECC71?style=flat-square" alt="Resources" />
</p>
...
### [🔌 MCP Servers](./catalog/mcp/) — <!-- README_COUNT_MCP:START -->7853<!-- README_COUNT_MCP:END --> entries
...
| [Headroom](https://github.com/chopratejas/headroom) | 53.4k | 98 | AI context compression layer for agents, reducing token usage 60-95%… |
...
### [🎯 Skills](./catalog/skills/) — <!-- README_COUNT_SKILL:START -->12289<!-- README_COUNT_SKILL:END --> entries
...
### [💡 Prompts](./catalog/prompts/) — <!-- README_COUNT_PROMPT:START -->629<!-- README_COUNT_PROMPT:END --> entries
...
### [🧩 Plugins](./catalog/plugins/) — <!-- README_COUNT_PLUGIN:START -->1325<!-- README_COUNT_PLUGIN:END --> entries
