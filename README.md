...
<p><strong><!-- README_APPROX_COUNT:START -->29200<!-- README_APPROX_COUNT:END -->+ curated AI coding resources — browse, evaluate, install</strong><br/>MCP Servers · Skills · Rules · Prompts · Plugins</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/resources-29278-2ECC71?style=flat-square" alt="Resources" />
</p>
...
### [🔌 MCP Servers](./catalog/mcp/) — <!-- README_COUNT_MCP:START -->10831<!-- README_COUNT_MCP:END --> entries
...
|------|----------|-------|-------------|
| [Headroom](https://github.com/chopratejas/headroom) | 65.7k | 98 | AI context compression layer for agents, reducing token usage 60-95%… |
| [upstash/context7](https://github.com/upstash/context7) | 60.5k | 98 | An MCP server that injects real-time, version-specific library docume… |
| [ChromeDevTools/chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | 48.8k | 98 | Official Google MCP server enabling AI coding agents to control Chrom… |
| [DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp) | 38.3k | 98 | Code intelligence MCP server that indexes codebases into a persistent… |
| [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp) | 36.0k | 98 | Official Microsoft MCP server enabling AI to control web browsers via… |
<!-- README_TOP5_MCP:END -->
...
### [🎯 Skills](./catalog/skills/) — <!-- README_COUNT_SKILL:START -->13223<!-- README_COUNT_SKILL:END --> entries
...
### [💡 Prompts](./catalog/prompts/) — <!-- README_COUNT_PROMPT:START -->662<!-- README_COUNT_PROMPT:END --> entries
...
### [🧩 Plugins](./catalog/plugins/) — <!-- README_COUNT_PLUGIN:START -->1473<!-- README_COUNT_PLUGIN:END --> entries
