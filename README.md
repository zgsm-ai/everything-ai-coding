...
<p><strong><!-- README_APPROX_COUNT:START -->23000<!-- README_APPROX_COUNT:END -->+ curated AI coding resources — browse, evaluate, install</strong><br/>MCP Servers · Skills · Rules · Prompts · Plugins</p>
...
### [🔌 MCP Servers](./catalog/mcp/) — <!-- README_COUNT_MCP:START -->7611<!-- README_COUNT_MCP:END --> entries
...
|------|----------|-------|-------------|
| [upstash/context7](https://github.com/upstash/context7) | 57.9k | 98 | An MCP server that injects real-time, version-specific library docume… |
| [Headroom](https://github.com/chopratejas/headroom) | 47.8k | 98 | AI context compression layer for agents, reducing token usage 60-95%… |
| [ChromeDevTools/chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | 44.2k | 98 | Official Google MCP server enabling AI coding agents to control Chrom… |
...
### [🎯 Skills](./catalog/skills/) — <!-- README_COUNT_SKILL:START -->10360<!-- README_COUNT_SKILL:END --> entries
...
| [pi-subagents](https://github.com/nicobailon/pi-subagents/tree/main/skills/pi-subagents) | github-trending | 96 | A skill for orchestrating AI-assisted coding workflows with subagents… |
...
### [🧩 Plugins](./catalog/plugins/) — <!-- README_COUNT_PLUGIN:START -->1855<!-- README_COUNT_PLUGIN:END --> entries
