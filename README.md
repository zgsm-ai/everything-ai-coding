...
<p><strong><!-- README_APPROX_COUNT:START -->24200<!-- README_APPROX_COUNT:END -->+ curated AI coding resources — browse, evaluate, install</strong><br/>MCP Servers · Skills · Rules · Prompts · Plugins</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/resources-24213-2ECC71?style=flat-square" alt="Resources" />
</p>
...
### [🔌 MCP Servers](./catalog/mcp/) — <!-- README_COUNT_MCP:START -->7830<!-- README_COUNT_MCP:END --> entries
...
|------|----------|-------|-------------|
| [upstash/context7](https://github.com/upstash/context7) | 58.0k | 98 | An MCP server that injects real-time, version-specific library docume… |
| [Headroom](https://github.com/chopratejas/headroom) | 50.6k | 98 | AI context compression layer for agents, reducing token usage 60-95%… |
| [ChromeDevTools/chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | 44.4k | 98 | Official Google MCP server enabling AI coding agents to control Chrom… |
| [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp) | 34.3k | 98 | Official Microsoft MCP server enabling AI to control web browsers via… |
...
### [🎯 Skills](./catalog/skills/) — <!-- README_COUNT_SKILL:START -->11683<!-- README_COUNT_SKILL:END --> entries
...
### [💡 Prompts](./catalog/prompts/) — <!-- README_COUNT_PROMPT:START -->623<!-- README_COUNT_PROMPT:END --> entries
...
### [🧩 Plugins](./catalog/plugins/) — <!-- README_COUNT_PLUGIN:START -->1320<!-- README_COUNT_PLUGIN:END --> entries
