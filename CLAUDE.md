...
- **Tier 1**: anthropics/skills + skillcreatorai/Ai-Agent-Skills（全量收录）
...
| vscode-costrict | `platforms/vscode-costrict/skills/coding-hub/SKILL.md` | 无（自包含于 SKILL.md） | `-` |
